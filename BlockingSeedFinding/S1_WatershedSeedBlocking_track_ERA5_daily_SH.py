...
#%% Save results
with open("/scratch/bell/hu1029/LGHW/SD_Blocking_peaking_date_daily_SH", "wb") as fp:
    pickle.dump(Blocking_peaking_date, fp)
with open("/scratch/bell/hu1029/LGHW/SD_Blocking_peaking_lon_daily_SH", "wb") as fp:
    pickle.dump(Blocking_peaking_lon, fp)
with open("/scratch/bell/hu1029/LGHW/SD_Blocking_peaking_lat_daily_SH", "wb") as fp:
    pickle.dump(Blocking_peaking_lat, fp)
with open("/scratch/bell/hu1029/LGHW/SD_BlockingTotal_date_SH", "wb") as fp:
    pickle.dump(BlockingTotal_date, fp)
with open("/scratch/bell/hu1029/LGHW/SD_BlockingTotal_label_SH", "wb") as fp:
    pickle.dump(BlockingTotal_label, fp)
with open("/scratch/bell/hu1029/LGHW/SD_BlockingTypeI_SH", "wb") as fp:
    pickle.dump(BlockingTypeI, fp)

# three types of blocking peaking date and location
with open("/scratch/bell/hu1029/LGHW/SD_Blocking_diversity_date_daily_SH", "wb") as fp:
    pickle.dump(Blocking_diversity_date, fp)
with open("/scratch/bell/hu1029/LGHW/SD_Blocking_diversity_label_daily_SH", "wb") as fp:
    pickle.dump(Blocking_diversity_label, fp)
with open("/scratch/bell/hu1029/LGHW/SD_Blocking_diversity_peaking_date_daily_SH", "wb") as fp:
    pickle.dump(Blocking_diversity_peaking_date, fp)
with open("/scratch/bell/hu1029/LGHW/SD_Blocking_diversity_peaking_lon_daily_SH", "wb") as fp:
    pickle.dump(Blocking_diversity_peaking_lon, fp)
with open("/scratch/bell/hu1029/LGHW/SD_Blocking_diversity_peaking_lat_daily_SH", "wb") as fp:
...
plt.ylabel('Latitude')
plt.savefig('SD_blockingFreq_daily_1979_2021_watershed_SH.png')  
plt.show()
plt.close()
...
#%% Save results
with open("/scratch/bell/hu1029/LGHW/SD_Seeding_peaking_date_daily_SH", "wb") as fp:
    pickle.dump(Seeding_peaking_date, fp)
with open("/scratch/bell/hu1029/LGHW/SD_Seeding_peaking_lon_daily_SH", "wb") as fp:
    pickle.dump(Seeding_peaking_lon, fp)
with open("/scratch/bell/hu1029/LGHW/SD_Seeding_peaking_lat_daily_SH", "wb") as fp:
    pickle.dump(Seeding_peaking_lat, fp)
with open("/scratch/bell/hu1029/LGHW/SD_SeedingTotal_date_SH", "wb") as fp:
    pickle.dump(SeedingTotal_date, fp)
with open("/scratch/bell/hu1029/LGHW/SD_SeedingTotal_label_SH", "wb") as fp:
    pickle.dump(SeedingTotal_label, fp)
with open("/scratch/bell/hu1029/LGHW/SD_SeedingTypeI_SH", "wb") as fp:
    pickle.dump(SeedingTypeI, fp)

# three types of seeding peaking date and location
with open("/scratch/bell/hu1029/LGHW/SD_Seeding_diversity_date_daily_SH", "wb") as fp:
    pickle.dump(Seeding_diversity_date, fp)
with open("/scratch/bell/hu1029/LGHW/SD_Seeding_diversity_label_daily_SH", "wb") as fp:
    pickle.dump(Seeding_diversity_label, fp)
with open("/scratch/bell/hu1029/LGHW/SD_Seeding_diversity_peaking_date_daily_SH", "wb") as fp:
    pickle.dump(Seeding_diversity_peaking_date, fp)
with open("/scratch/bell/hu1029/LGHW/SD_Seeding_diversity_peaking_lon_daily_SH", "wb") as fp:
    pickle.dump(Seeding_diversity_peaking_lon, fp)
with open("/scratch/bell/hu1029/LGHW/SD_Seeding_diversity_peaking_lat_daily_SH", "wb") as fp:
...
plt.xlabel('Longitude')
plt.ylabel('Latitude')
plt.savefig('SD_seedingFreq_daily_1979_2021_watershed_SH.png')  
plt.show()
plt.close()
