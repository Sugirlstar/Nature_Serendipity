...
#     with open(f'/scratch/bell/hu1029/LGHW/CCTrackLWA_1979_2021{HMi}.pkl', 'rb') as file:
#         LWAtrack_CC = pickle.load(file)
#     with open(f'/scratch/bell/hu1029/LGHW/ACTrackLWA_1979_2021{HMi}.pkl', 'rb') as file:
#         LWAtrack_AC = pickle.load(file)

#     flat_LWAtrack_CC = np.array([np.nanmean(sublist) for sublist in LWAtrack_CC])
#     flat_LWAtrack_AC = np.array([np.nanmean(sublist) for sublist in LWAtrack_AC])
...
#     plt.title(f'Probability Density Function (PDF){HMi}')
#     plt.xlabel('TRACK LWA')
#     plt.ylabel('Density')
#     plt.legend()  
#     plt.savefig(f'CCandACtrackLWA_2PDF{HMi}.png')
#     plt.show()
