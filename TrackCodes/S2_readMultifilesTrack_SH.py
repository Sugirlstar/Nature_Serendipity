...
for i in range(len(datasets)):
    ...
    base_dir = f'/scratch/bell/hu1029/LGHW/TRACK/{dtname}_TRACK_inputdata_geopotentialAnomaly_yearly/TRACKS_SH/'
    ...
    with open(f'{OUT_DIR}/{dtname}_CCZanom_allyearTracks_SH.pkl', 'wb') as file:
        pickle.dump(allyear_Tracks, file)  

    with open(f'{OUT_DIR}/{dtname}_CCZanom_allyearTracks_SH.pkl', 'rb') as file:
    ...
    with open(f'{OUT_DIR}/{dtname}_ACZanom_allyearTracks_SH.pkl', 'wb') as file:
        pickle.dump(allyear_Tracks, file)  

    with open(f'{OUT_DIR}/{dtname}_ACZanom_allyearTracks_SH.pkl', 'rb') as file:
        allyearTracks = pickle.load(file)
