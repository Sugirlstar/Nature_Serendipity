...
datares = ['1dg', 'F128']
datarespath = {'1dg': '/scratch/bell/hu1029/Data/processed/ERA5_Z500_6hr_1979_2021_1dg.nc',
               'F128': '/scratch/bell/hu1029/Data/processed/ERA5_Z500_6hr_1979_2021_F128.nc'}
varnameList = {'1dg': 'z',
           'F128': 'var129'}
...
for resi in  ['F128', '1dg']:
    ...
    ds.to_netcdf(f'/scratch/bell/hu1029/Data/processed/ERA5_Z500anomaly_subtractseasonal_6hr_1979_2021_{resi}.nc')
    print('Calculated')
    # save the climatology into netCDF file
    ds2 = ds.copy()
    ds2[zname] = climatology
    ds2.to_netcdf(f'/scratch/bell/hu1029/Data/processed/ERA5_Z500climatology_monthly_1979_2021_{resi}.nc')
    ...
    plt.show()
    plt.savefig(f'ZanomClim12Months_{resi}.png')
