...
INPUT_File=/scratch/bell/hu1029/Data/processed/JRA55_Z500anomaly_subtractseasonal_6hr_1979_2021_F128.nc
OUTPUT_DIR=/scratch/bell/hu1029/LGHW/TRACK/JRA55_TRACK_inputdata_geopotentialAnomaly_yearly
...
for year in $(seq 1979 2021); do
    ...
    OUTFILE=${OUTPUT_DIR}/JRA55_geopotentialAnomaly_6hr_${year}.nc
